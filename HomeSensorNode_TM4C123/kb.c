...
void initKb(void)
{
    ...
    // Configure keyboard
    // Columns 0-3 with open-drain outputs connected to PB0, PB1, PB4, PA6
...
bool kbhit(void)
{
    bool empty = (keyboardReadIndex == keyboardWriteIndex);
    return !empty;
}
